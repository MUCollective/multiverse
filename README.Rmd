...
<!-- badges: start -->
[![Build status](https://travis-ci.com/MUCollective/multiverse.svg?branch=master)](https://travis-ci.com/MUCollective/multiverse)
...
You can install the development version from [GitHub](https://github.com/MUcollective/multiverse) with:
