...
We should be able to express these conditions in the multiverse. We show how this can be done, as well as other details on  `conditions`, in the corresponding [vignette](mucollective.github.io/multiverse/articles/conditions.html).
