...
p_list <- list(
    speed_calculation = "speed_calculation_option1",
    comprehension_score = "comprehension_score_option1",
    transform_speed = "transform_speed_option1",
    speed_outlier_filtering = "speed_outlier_filtering_option1"
  )

profvis(lapply(.an_expr, get_parameter_code, p_list))
```
