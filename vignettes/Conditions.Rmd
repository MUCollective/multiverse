...
alist2 <- lapply( list(x2), get_parameter_conditions )
akeys2 <- unique(unlist(lapply(alist2, names)))
parameter_conditions_list <- setNames(do.call(mapply, c(FUN=c, alist2)), akeys)

# parameter_conditions_list$parameters

do.call(mapply, c(FUN=c, alist2))
```
...
alist <- lapply( x, get_parameter_conditions )
parameter_conditions_list <- combine_parameter_conditions_list(alist)
```
