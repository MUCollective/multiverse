...
p1 <- data.spec_curve %>%
  ...
  rbind( data.frame(
    parameter_name = c("cycle length", "certainty", "menstrual calc.", "fertile", "relationship"),
    parameter_option = c("cycle length", "certainty", "menstrual calc.", "fertile", "relationship"),
    .universe = NA
  ))  %>%
  mutate(
...
cowplot::plot_grid(p2, p1, ncol = 1, rel_heights = c(1, 2), align = "v")
```
