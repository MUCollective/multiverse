...
animate(p.above, nframes = n, fps = 3, width = 9, height = 4, res = 300, units = "in")
```
...
animate(p.below, nframes = n, fps = 3, width = 9, height = 4, res = 300, units = "in")
```
...
animate(p.fitted_lines, nframes = n, fps = 3, width = 9, height = 6, res = 300, units = "in")
```
