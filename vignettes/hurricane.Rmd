...
fit <- glm(branch(model,
              "linear_model" ~ log(death + 1),
              "poisson" ~ death
          ) ~ branch(predictors,
              "1" ~ femininity * damage,
              "2" ~ femininity * damage + femininity * zmin,
              "3" ~ femininity * damage + femininity * zwin,
              "4" ~ femininity * damage + femininity * zcat,
              "5" ~ femininity * damage + femininity * z3,
              "6" ~ femininity + damage + z3
          ) + 
          branch(covariates,
              "1" ~ NULL,
              "2" ~ year:damage,
