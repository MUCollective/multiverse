...
## Example 4: Defining parameters separately
...
## Example 5: Parameters can be re-used (and alternate ways of declaring the same branch)
...
- the family argument in the modelling function
