...
The `multiverse_table` shows that there are two rows for the `data transform` branch which correspond to the two different reasonable alternatives for transforming time spent data.
