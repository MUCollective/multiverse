...
```{multiverse default-m-2, inside = M, echo = FALSE, eval = params$EVAL}
...
```{multiverse default-m-3, inside = M, echo = FALSE, eval = params$EVAL, message = FALSE, warning = FALSE}
...
```{multiverse default-m-4, inside = M, echo = FALSE, eval = params$EVAL}
