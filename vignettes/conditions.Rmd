...
Specifying these conditions allows us to exclude inconsistent combinations from our analyses. Let's update the example from [home page](mucollective.github.io/multiverse/) by including these conditions:
